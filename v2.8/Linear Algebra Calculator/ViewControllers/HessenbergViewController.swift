//
//  HessenbergViewController.swift
...
class HessenbergViewController: UIViewController, KeyboardButtonClicked, UITextFieldDelegate, SavedMatricesDelegate {
        ...
        if check {
            ...
            if tag == 13 {
                ...
                if screen.row == 1 && screen.firstLineColumn == 1 {
                    ...
                    screen.label1.text = "只有方阵才可以进行Hessenberg化哦～！"
                    check = false
