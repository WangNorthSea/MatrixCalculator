...
class MultiplicationViewController: UIViewController, Keyboard2ButtonClicked, UITextFieldDelegate, SavedMatricesDelegate {
        ...
        if check {
            if numberOfMatrix == 0 {
                ...
                if tag == 13 {
                    ...
                    if calculate.A.columns == calculate.B?.rows {
                        screen.inputString = calculate.multiplication(calculate.A, calculate.B!)
                        screen.label1.text = screen.inputString
                        ...
                        screen.label1.text = "矩阵A的列数要等于矩阵B的行数哦～！"
                        screen.label2.text = ""
                        check = false
