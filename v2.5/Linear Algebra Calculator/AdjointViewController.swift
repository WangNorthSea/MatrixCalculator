...
class AdjointViewController: UIViewController, KeyboardButtonClicked, UITextFieldDelegate, SavedMatricesDelegate {
        ...
        if check {
            if screen.column <= screen.firstLineColumn {
                ...
                if tag == 12 {
                    if screen.inputString.count > 0 {
                        screen.backupString2 = screen.inputString
                        while screen.backupString2.last != nil && (screen.figureArray.contains(screen.backupString.last!) || screen.backupString.last! == ".") {
                            screen.backupString2.remove(at: screen.backupString2.index(before: screen.backupString2.endIndex))
                            if screen.backupString2.count > 0 {
                                if screen.backupString2.last! == "/" {
                                    return
            ...
            if tag == 13 {
                ...
                if screen.row == screen.firstLineColumn {
                    ...
                    if calculate.A.rows == 1 {
                        screen.inputString = "1.0"
                        screen.label1.text = screen.inputString
                        screen.label2.text = "A* = "
                    }
                    else {
                        screen.inputString = calculate.adjointMatrix()
                        screen.label1.text = screen.inputString
                        screen.label2.text = "A* = "
                    }
                    check = false
                    ...
                    screen.label1.text = "只有方阵才可以求伴随矩阵哦～！"
                    check = false
