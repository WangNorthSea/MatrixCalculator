...
class AdditionViewController: UIViewController, Keyboard2ButtonClicked, UITextFieldDelegate, SavedMatricesDelegate {
            ...
            if numberOfMatrix == 0 {
                ...
                if tag == 13 {
                    ...
                    if calculate.A.rows == calculate.B?.rows && calculate.A.columns == calculate.B?.columns {
                        screen.inputString = calculate.addition(calculate.A, calculate.B!)
                        screen.label1.text = screen.inputString
