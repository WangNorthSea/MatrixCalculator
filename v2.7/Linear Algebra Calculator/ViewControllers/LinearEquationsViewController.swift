//
//  LinearEquationsViewController.swift
//  Linear Algebra Calculator
//
//  Created by 王浩宇 on 2018/5/28.
...
class LinearEquationsViewController: UIViewController, KeyboardButtonClicked, UITextFieldDelegate, SavedMatricesDelegate {
    ...
    override func viewDidLoad() {
        ...
        screen.label2.text = "请输入扩充后的系数矩阵"
        loadUI()
    }
    ...
    @objc func decimalOrFraction() {
        ...
        if check || !decimalOrFractionCheck {
            ...
            screen.inputString = calculate.decimalOrFractionLE(screen.inputString)
    ...
    func buttonClicked(tag: Int) {
        if check {
            ...
            if tag == 13 {
                ...
                if calculate.A.columns == 1 {
                    screen.label1.textColor = UIColor.red
                    screen.label1.text = "扩充后的系数矩阵列数应大于2哦～！"
                    screen.label2.text = ""
                    decimalOrFractionCheck = false
                }
                else {
                    screen.inputString = calculate.solveLinearEquations(calculate.A)
                    if screen.inputString.first! != "x" {
                        screen.label1.textColor = UIColor.red
                        screen.label1.text = screen.inputString
                        screen.label2.text = ""
                        decimalOrFractionCheck = false
                        ...
                        screen.label1.text = screen.inputString
                        if screen.inputString.contains("α") {
                            screen.label2.text = "该线性方程组的通解为："
                            decimalOrFractionCheck = false
                        }
                        else {
                            screen.label2.text = "该线性方程组的解为："
                        }
                    }
                }
                check = false
